...
function Subjects() {
  ...
  return (
    <div className="container mx-auto p-1 lg:p-4 md:p-6 bg-gray-50 min-h-screen">
      <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center mb-2 text-gray-900 border-b-2 border-blue-500 pb-2"><i class="sm:hidden fas fa-book-open mr-2 text-teal-500"></i>Subject Overview</h1>
            ...
            <ul className="list-disc pl-5 space-y-2">
              {classData.subjects.map((subject, idx) => (
                <li key={idx} className="text-gray-600 flex items-center">
                  <i className="sm:hidden fas fa-book mr-2 text-blue-500"></i>
                  {subject.subjectName}
                </li>
              ))}
            </ul>
