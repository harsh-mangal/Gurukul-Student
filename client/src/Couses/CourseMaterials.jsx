...
const CourseMaterial = () => {
  ...
  return (
    <div className="container mx-auto lg:p-3 sm:p-4">
      ...
      <i class="sm:hidden fas fa-folder-open mr-2 text-sky-400"></i>{student ? `Course Materials for ${student.class}` : 'Loading student details...'}
      </h1>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="sm:hidden grid grid-cols-1 gap-3 sm:gap-4">
            {courseMaterials.map((material, index) => (
